...
function App() {
  ...
  const handleExportGeoTIFF = useCallback(async () => {
    ...
    try {
      ...
      const subsetRowOffset = Math.floor(srcRowStart / effectiveMl);
      ...
      if (isRendered) {
        ...
        if (displayMode === 'rgb' && compositeId) {
          ...
          filename = `sardine_${bandNames.join('-')}_${compositeId}_ml${effectiveMl}_${exportWidth}x${exportHeight}${subsetBbox ? '_subset' : ''}.tif`;
        } else {
